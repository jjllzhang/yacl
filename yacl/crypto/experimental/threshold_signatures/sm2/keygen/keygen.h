...
#include "yacl/crypto/experimental/threshold_signatures/sm2/messages/mta_messages.h"
...
#include "yacl/crypto/experimental/threshold_signatures/sm2/proofs/types.h"
#include "yacl/crypto/experimental/threshold_signatures/sm2/zid/zid.h"
...
class KeygenParty {
 ...
 private:
  ...
  bool round3_requests_done_ = false;
  bool round3_responses_done_ = false;
